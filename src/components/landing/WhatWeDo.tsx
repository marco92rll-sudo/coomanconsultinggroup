          ...
          >
            <div className="relative flex flex-col items-center">
              ...
              <div
                ...
                style={{
                  boxShadow: "0 0 80px rgba(139,171,184,0.1), 0 0 30px rgba(139,171,184,0.05)",
                }}
              >
                <Suspense
                  fallback={
                    <div className="w-[320px] h-[320px] md:w-[360px] md:h-[360px] rounded-full bg-card animate-pulse" />
                  }
                >
                  <Globe3D />
                </Suspense>
              ...
              {/* Testimonial card below globe */}
              <div
                className="mt-6 w-[320px] md:w-[380px] rounded-lg px-6 py-5 text-center"
                style={{
              ...
              >
                ...
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <div className="flex gap-0.5">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star key={i} size={12} fill="hsl(var(--cta))" color="hsl(var(--cta))" />
                    ))}
                  </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <p style={{ fontSize: 12, color: "rgba(255,255,255,0.55)", lineHeight: 1.7, fontStyle: "italic" }}>
                      "{t.quote}"
                    </p>
                    <p className="mt-3" style={{ fontSize: 10, fontWeight: 600, color: "hsl(var(--primary))" }}>
                      — {t.title}
                    </p>
                  </motion.div>
                </AnimatePresence>
