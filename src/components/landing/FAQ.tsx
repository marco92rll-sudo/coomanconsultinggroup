...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Our frameworks are built for complex B2B sales cycles — typically professional services, SaaS, and high-value consulting businesses where relationships and positioning drive revenue.",
  },
];
